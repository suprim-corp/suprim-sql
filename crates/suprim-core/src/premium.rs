...
//! lives in the `suprim-extensions` private crate and is wired in via `main.rs`
//! when built with `--features extensions`.
...
/// and the real `suprim-extensions` crate.
...
// All limits and license logic live exclusively in the private `suprim-extensions` crate.
