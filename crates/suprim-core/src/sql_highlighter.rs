...
//!
//! Lives in suprim-core (behind `ui` feature) so both the app crate and
//! the premium crate can use it without duplicating code.

use egui::text::LayoutJob;
use egui::{Color32, FontId, TextFormat};

use crate::db::sql_keywords::{SQL_CONSTANTS, SQL_FUNCTIONS, SQL_KEYWORDS, SQL_TYPES};
